...
export interface CartDiscountAllocationTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'CartAutomaticDiscountAllocation' | 'CartCodeDiscountAllocation' | Promise<'CartAutomaticDiscountAllocation' | 'CartCodeDiscountAllocation'>;
}
...
export interface DisplayableErrorTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'CartUserError' | 'CheckoutUserError' | 'CustomerUserError' | 'UserError' | Promise<'CartUserError' | 'CheckoutUserError' | 'CustomerUserError' | 'UserError'>;
}
...
export interface HasMetafieldsTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'Article' | 'Blog' | 'Collection' | 'Customer' | 'Order' | 'Page' | 'Product' | 'ProductVariant' | 'Shop' | Promise<'Article' | 'Blog' | 'Collection' | 'Customer' | 'Order' | 'Page' | 'Product' | 'ProductVariant' | 'Shop'>;
}
...
export interface NodeTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'AppliedGiftCard' | 'Article' | 'Blog' | 'Cart' | 'CartLine' | 'Checkout' | 'CheckoutLineItem' | 'Collection' | 'Comment' | 'ExternalVideo' | 'Location' | 'MailingAddress' | 'MediaImage' | 'Metafield' | 'Model3d' | 'Order' | 'Page' | 'Payment' | 'Product' | 'ProductOption' | 'ProductVariant' | 'ShopPolicy' | 'Video' | Promise<'AppliedGiftCard' | 'Article' | 'Blog' | 'Cart' | 'CartLine' | 'Checkout' | 'CheckoutLineItem' | 'Collection' | 'Comment' | 'ExternalVideo' | 'Location' | 'MailingAddress' | 'MediaImage' | 'Metafield' | 'Model3d' | 'Order' | 'Page' | 'Payment' | 'Product' | 'ProductOption' | 'ProductVariant' | 'ShopPolicy' | 'Video'>;
}
